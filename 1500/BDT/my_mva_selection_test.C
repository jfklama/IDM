...
void my_mva_selection_test(string // signame1 = "root_withSmear1_check/correlated_met/idm_hphm_slep_BP18_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_BP21_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_BP23_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP1_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP3_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP4_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP5_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP11_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP11_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP15_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP19_1500DataPreselected.root",   // signal tree for training //all samples
				 // signame1 = "root_withSmear1_check/correlated_met/idm_hphm_slep_BP21_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_BP23_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP1_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP4_1500DataPreselected.root", //real W
				 signame1 = "root_withSmear1_check/correlated_met/idm_hphm_slep_BP18_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP2_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP3_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP5_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP6_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP11_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP12_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP13_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP14_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP15_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP16_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP17_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP18_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP19_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP20_1500DataPreselected.root", //virual W (all)
				 // signame1 = "root_withSmear1_check/correlated_met/idm_hphm_slep_BP18_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP11_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP12_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP13_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP14_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP15_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP16_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP18_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP19_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_hphm_slep_HP20_1500DataPreselected.root", //virual W
			   string bgname1 = "root_withSmear1_check/correlated_met/idm_bg_ll_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_bg_qq_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_bg_qqll_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_bg_qqlv_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_bg_qqlvlv_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_bg_qqlvvv_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_bg_qqqq_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_bg_qqqqlv_1500DataPreselected.root root_withSmear1_check/correlated_met/idm_bg_qqvv_1500DataPreselected.root",    // background tree for training
			   string signame2 = "HP13",   // signal tree for testing
			   string bgname2 = "",    // background tree for testing
				 string variables = "jetsM_inv jetsEnergy jetsTheta leptonEnergy leptonTheta leptonPt jetDeltaTheta jetDeltaPhi EFsum MET missingMass", // input BDT variable names
			   string spectator = "Ievt crossSection sampleName w", // spectator variable names (for output tree)
			   double nsgen= 6391.0,     // expected signal events
			   double nbgen= 1078917.0,     // expected background events
			   ...
			   string bdtpar = "UseNvars=6:PruneMethod=CostComplexity:PruneStrength=-1", // BDT options
				 string testdir = "withSmear1_check/correlated_met",
			 	 string shellmode = "off")
{
  ...
  // Decode input tree names
	...
	string fullSigname2 = "root_" + testdir + "/idm_hphm_slep_" + signame2 + "_1500DataPreselected.root";
	if (testdir=="") fullSigname2 = "";
 ...
 */
 ...
 // ---------------------------------------------------------------
   ...
   */
	 ...
	 TString dataset = (shellmode == "off") ? "dataset_off_shell" + testdir : "dataset_on_shell" + testdir;
...
*/
   ...
   //TString dataset= (shellmode == "off") ? "dataset_off_shell" : "dataset_on_shell";
   ...
   gStyle->SetOptLogy(0);
	 ...
	 if(transf == "I")
	 	...
	 	InputVarDir += "eco";
 	 	...
 	 	InputVarDir = "InputVariables_Uniform_Deco";
	 else if(transf == "U+G+D+N")
 	 	InputVarDir = "InputVariables_Uniform_Gauss_Deco_Norm";
   ...
   TString formula="S/sqrt(S+B)";
	 ...
	 TString outSig = "./outputResults/" + outfile + "_sig_" + signame2 + ".txt";
