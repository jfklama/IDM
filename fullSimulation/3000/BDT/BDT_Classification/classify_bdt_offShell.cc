...
#include "dataset_off_shell/weights/my_mva_selection_BDT.class.C"
...
int main(int argc, char** argv ){
  ...
  string inputFileName  = "../inputs/R12/HP17_DataPreselected.root";
  string outputFileName = "BDT_AppTest/event.root";

  string sigChannel = "HP17";

  if(argc>2) {
    sigChannel = argv[2];
    inputFileName  = "../inputs/R12/" + sigChannel + "_DataPreselected.root";
    outputFileName = "BDT_Classified/_allBackrounds_withCuts/off_shell/" + sigChannel + "_classified.root";
  }
/*
  // Initialize root
...
*/
  ...
  tout->Branch( "data",&mydata, "jetsM_inv/F:jetsEnergy:jetsTheta:leptonEnergy:leptonTheta:leptonPt:jetDeltaTheta:jetDeltaPhi:EFsum:MET:missingMass:jet1Theta:jet2Theta:jet1Pt:jet2Pt:jet1E:jet2E:M_inv_Wlep");
...
*/
  const string myInputVars[] = { "jetsM_inv", "jetsEnergy", "jetsTheta", "leptonEnergy","leptonTheta", "leptonPt", "jetDeltaTheta", "jetDeltaPhi", "EFsum", "MET", "missingMass", "jet1Theta", "jet2Theta", "jet1Pt", "jet2Pt", "jet1E", "jet2E", "M_inv_Wlep" };
  int myNvar=18;

  vector<double> myInputVariableValues(18);
