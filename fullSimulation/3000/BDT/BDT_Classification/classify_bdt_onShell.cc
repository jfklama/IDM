...
#include "dataset_on_shell/weights/my_mva_selection_BDT.class.C"
...
int main(int argc, char** argv ){
  ...
  if(argc>2) {
    ...
    outputFileName = "BDT_Classified/_allBackrounds_withCuts/on_shell/" + sigChannel + "_classified.root";
  }
/*
  // Initialize root
