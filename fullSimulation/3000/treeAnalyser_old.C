...
void treeAnalyser::Loop(double crossSection =  4.213, double R = 1.2 )
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
  ...
  cout << "Analysing " << channel << " sample..." << endl;
   ...
   TH1 *lepNuMass = new TH1F("WlepMass", "", 50, 0.0, 300.0);
   TH1 *jetsEnergy = new TH1F("jetsEnergy", "", 100, 0.0, 2000.0);
   TH1 *jetsTheta = new TH1F("jetsTheta", "", 175, 0.0, 3.5);
   TH1 *jetDeltaTheta = new TH1F("jetDeltaTheta", "", 80, 0.0, 0.2);
   TH1 *jetDeltaPhi = new TH1F("jetDeltaPhi", "", 100, 0.0, 0.25);
   ...
   TH1 *met = new TH1F("met", "", 310, 0.0, 3100.0);
   ...
   TFile *outputFile = new TFile("./BDT/inputs/" + channel + "_DataPreselected.root","RECREATE");
   ...
   event->Branch( "data",&mydata, "jetsM_inv/F:jetsEnergy:jetsTheta:leptonEnergy:leptonTheta:leptonPt:jetDeltaTheta:jetDeltaPhi:EFsum:MET:missingMass" );
