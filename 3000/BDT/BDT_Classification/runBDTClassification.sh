...
declare -a offshell=(BP18 HP2 HP3 HP5 HP6 HP7 HP8 HP9 HP10 HP11 HP12
...
withOverlayOffShell=$(g++ -o classify_bdt_withOverlayOffShell -std=gnu++17 -I  `root-config --incdir` classify_bdt_withOverlayOffShell.cc `root-config --libs`)
...
withOverlayOnShell=$(g++ -o classify_bdt_withOverlayOnShell -std=gnu++17 -I  `root-config --incdir` classify_bdt_withOverlayOnShell.cc `root-config --libs`)
