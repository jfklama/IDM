...
#include "dataset_on_shellwithOverlay_alternativeMissingP4_noMlv/weights/my_mva_selection_test_BDT.class.C"
...
int main(int argc, char** argv ){
  ...
  string inputFileName  = "../root_withOverlay_cutsForFastSim_corrCMSAngles/idm_hphm_slep_BP18_3000DataPreselected.root";
  ...
  if(argc>2) {
    sigChannel = argv[2];
    inputFileName  = "../root_withOverlay_alternativeMissingP4/idm_hphm_slep_" + sigChannel + "_3000DataPreselected.root";
    outputFileName = "BDT_Classified/withOverlay_alternativeMissingP4/on_shell/" + sigChannel + "_classified.root";
  }
/*
  // Initialize root
