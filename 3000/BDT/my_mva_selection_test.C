...
void my_mva_selection_test(string // signame1 = "root_withSmear1/idm_hphm_slep_BP18_3000DataPreselected.root root_withSmear1/idm_hphm_slep_BP21_3000DataPreselected.root root_withSmear1/idm_hphm_slep_BP23_3000DataPreselected.root root_withSmear1/idm_hphm_slep_HP1_3000DataPreselected.root root_withSmear1/idm_hphm_slep_HP3_3000DataPreselected.root root_withSmear1/idm_hphm_slep_HP4_3000DataPreselected.root root_withSmear1/idm_hphm_slep_HP5_3000DataPreselected.root root_withSmear1/idm_hphm_slep_HP9_3000DataPreselected.root root_withSmear1/idm_hphm_slep_HP11_3000DataPreselected.root root_withSmear1/idm_hphm_slep_HP15_3000DataPreselected.root root_withSmear1/idm_hphm_slep_HP19_3000DataPreselected.root",   // signal tree for training //all samples
			   ...
			   double nsgen= 2707.0,     // expected signal events
			   double nbgen= 743701.0,     // expected background events
			   ...
			   string bdtpar = "UseNvars=6:PruneMethod=CostComplexity:PruneStrength=-1", // BDT options
				 string testdir = "root_noSmear",
			 	 string shellmode = "off") // directory with a file to test on
{
  ...
  nevents.clear();
	...
	string fullSigname2 = "root_" + testdir + "/idm_hphm_slep_" + signame2 + "_3000DataPreselected.root";
...
*/
 ...
 // Number of events expected in each tree
   ...
   gGui->RaiseDialog();
/*
	 TFormula f("sigf",gGui->GetFormula());
   TIter next(fInfoList);
   MethodInfo* info(0);

	 cout << info->sSig->GetMaximum() << " " << info->maxSignificance << endl;
*/
   canvas1 = (TCanvas *) gROOT->FindObject("canvas1");
