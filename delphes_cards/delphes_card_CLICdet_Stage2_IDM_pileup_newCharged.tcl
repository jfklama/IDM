...
module PileUpMerger PileUpMerger {
  ...
  set PileUpFile CLIC_overlay_1.4tev_2_defaultSelected_batch20FullSelection10ns.pileup

  # average expected pile up
  set MeanPileUp 26

  # distribturion of overlay events (0 for Poisson, 1 for Uniform)
  set PileUpDistribution 0

   # maximum spread in the beam direction in m
  set ZVertexSpread 0.01
...
module Efficiency ChargedHadronTrackingEfficiency {
 ...
 (pt > 0.1) * (energy < 3)                 * (abs(eta) <= 2.54 && abs(eta) > 0.55 ) * (1.000) +
...
module SimpleCalorimeter ECal {
    ...
    # energy fraction for Higgs/IDM scalars (when set to stable in Pythia)
    add EnergyFraction {25} {0.0}
...
module PdgCodeFilter IDMFilter {
...
module TreeWriter TreeWriter {
   ...
   ###with jet energy smearing and jet energy scaling
    ...
    add Branch HCal/eflowNeutralHadrons EFlowNeutralHadronGen GenParticle
